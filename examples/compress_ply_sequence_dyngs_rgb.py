...
from gsplat.compression import SeqHevcCompressionRGB
...
class Runner:
    def __init__(
        ...
        if cfg.compression == "seq_hevc":
            self.compression_method = SeqHevcCompressionRGB(**self.compression_cfg)
    ...
    def compress(self,):
        ...
        raw_shN = splats_videos["shN"].cpu().detach().numpy()
