...
from gsplat.compression import SeqHevcCompressionBlockSortUD
...
class VideoCompressionConfig(CompressionConfig):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        video_compression_attrs = [
            ...
            "use_all_intra", "debug", "block_size", "threshold_size"
        ]
...
class Runner:
    def __init__(
        ...
        if cfg.compression == "seq_hevc":
            self.compression_method = SeqHevcCompressionBlockSortUD(**self.compression_cfg)
    ...
    def compress(self, ):
        ...
        video_splats_c, flip_info = self.compression_method.decompress(compress_dir)
        splats_list_c = self.compression_method.deorganize(video_splats_c, flip_info)
